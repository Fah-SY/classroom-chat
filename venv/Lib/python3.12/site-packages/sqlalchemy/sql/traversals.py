...
***REMOVED***:
            ...
            if lhc and rhc:
                if lv._gen_cache_key(
                    self.anon_map[0], []
        ***REMOVED*** != rv._gen_cache_key(self.anon_map[1], []):
                    return COMPARE_FAILED
            elif lhc != rhc:
                return COMPARE_FAILED
            elif lv != rv:
    ...
    def visit_multi(
        ...
        if lhc and rhc:
            if left._gen_cache_key(
                self.anon_map[0], []
    ***REMOVED*** != right._gen_cache_key(self.anon_map[1], []):
                return COMPARE_FAILED
        elif lhc != rhc:
            return COMPARE_FAILED
        else:
...
***REMOVED*** == _resolve_name_for_compare(
...
***REMOVED*** in zip_longest(left, right, fillvalue=(None, None, None, None)):
            if l_flags != r_flags:
                return COMPARE_FAILED
