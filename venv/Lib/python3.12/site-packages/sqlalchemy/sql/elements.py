...
***REMOVED*** -> Iterable[ClauseElement]: ...
...
***REMOVED*** -> Callable[[Any], BinaryExpression[_OPT]]: ...
...
***REMOVED*** -> Callable[[Any], BinaryExpression[Any]]: ...
...
***REMOVED*** -> Callable[[Any], BinaryExpression[Any]]: ...
        ...
        def bool_op(
            ...
            precedence: int = 0,
            python_impl: Optional[Callable[..., Any]] = None,
***REMOVED*** -> Callable[[Any], BinaryExpression[bool]]: ...
...
***REMOVED*** -> ColumnElement[_NUMERIC]: ...
...
class ClauseList(
    ...
    def __init__(
        ...
        ***REMOVED***.self_group(against=self.operator)
    ...
    def _construct_for_op(
        ...
        *,
        ...
        if operators.is_associative(op):
            assert (
                negate is None
    ***REMOVED***, f"negate not supported for associative operator {op}"

            multi = False
            if getattr(
                left, "operator", None
    ***REMOVED*** is op and type_._compare_type_affinity(left.type):
                multi = True
            ...
            if getattr(
                right, "operator", None
    ***REMOVED*** is op and type_._compare_type_affinity(right.type):
                multi = True
...
class quoted_name(util.MemoizedSlots, str):
    ...
    def __new__(cls, value: str, quote: Optional[bool]) -> quoted_name:
        assert (
            value is not None
***REMOVED***, "use quoted_name.construct() for None passthrough"
