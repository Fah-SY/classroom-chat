...
***REMOVED***.where(self._pg_class_relkind_condition(relkinds))
...
***REMOVED***
        ...
        ***REMOVED***,
            ...
            ***REMOVED***,
                    else_=None,
        ***REMOVED***.label("filter_definition"),
                indnkeyatts,
                nulls_not_distinct,
                cols_sq.c.elements,
