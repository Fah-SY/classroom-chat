...
***REMOVED*** or hasattr(cls_, "_sa_decl_prepare")
...
***REMOVED*** or bool(self.dataclass_setup_arguments)
...
***REMOVED***
    ...
    ***REMOVED***:
                ...
                ***REMOVED***, cls_annotations.get(field.name), True
                    else:
...
***REMOVED*** in bases:
            ...
            for (
                ...
                annotation,
                is_dataclass_field,
    ***REMOVED*** in local_attributes_for_class():
    ...
    ***REMOVED***
        ...
        ***REMOVED***
                for key, (
                    ...
                    originating_module,
                    originating_class,
        ***REMOVED*** in self.collected_annotations.items()
    ...
    ***REMOVED***
        ...
        if warn_for_non_dc_attrs:
            for (
                originating_class,
                non_dc_attrs,
    ***REMOVED*** in warn_for_non_dc_attrs.items():
        ...
        ***REMOVED***
                ...
                if isinstance(value, _IntrospectsAnnotations):
                    (
                        ...
                        originating_module,
                        originating_class,
            ***REMOVED*** = self.collected_annotations.get(
...
***REMOVED***.__mapper__._dispose_called
    ):
...
***REMOVED***:
    ...
    ***REMOVED***
            ...
            cast(
                "MappedClassProtocol[Any]", cls
    ***REMOVED***.__mapper__._expire_memoizations()
    else:
        type.__delattr__(cls, key)
