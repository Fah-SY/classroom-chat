...
***REMOVED***
    ...
    ***REMOVED***
            for (
                ...
                has_all_pks,
                has_all_defaults,
    ***REMOVED*** in persistence._collect_insert_commands(
                table,
...
***REMOVED***:
    ...
    ***REMOVED***
    ...
    def _get_crud_kv_pairs(cls, statement, kv_iterator, needs_to_be_cacheable):
        assert (
            needs_to_be_cacheable
***REMOVED***, "no test coverage for needs_to_be_cacheable=False"
...
class BulkUDCompileState(ORMDMLState):
    ...
    def orm_pre_session_exec(
        ...
        (
            update_options,
            execution_options,
***REMOVED*** = BulkUDCompileState.default_update_options.from_execution_options(
...
class BulkORMInsert(ORMDMLState, InsertDMLState):
    ...
    def orm_pre_session_exec(
        ...
        (
            insert_options,
            execution_options,
***REMOVED*** = BulkORMInsert.default_insert_options.from_execution_options(
