...
***REMOVED***
    ...
    ***REMOVED*** = context.result_column_struct
            num_ctx_cols = len(result_columns)
        else:
            result_columns = cols_are_ordered = (  # type: ignore
                num_ctx_cols
    ***REMOVED*** = ad_hoc_textual = loose_column_name_matching = (
                textual_ordered
    ***REMOVED*** = False
...
***REMOVED***
    ...
    ***REMOVED***
        ...
        for (
            ...
            untranslated,
            coltype,
***REMOVED*** in self._colnames_from_description(context, cursor_description):
            if idx < num_ctx_cols:
...
class BufferedRowCursorFetchStrategy(CursorFetchStrategy):
    ...
    ***REMOVED***.execute(text("select * from table"))
