...
class _AbstractLoad(traversals.GenerativeOnTraversal, LoaderOption):
    ...
    ***REMOVED***.options(contains_eager(User.addresses)).populate_existing()
...
***REMOVED***, "this should only be called if _extra_criteria is present"
...
class _TokenStrategyLoad(_LoadElement):
    ...
    ***REMOVED***
        ...
        ***REMOVED***._generate_natural_for_superclasses()
    ***REMOVED***
        ]
