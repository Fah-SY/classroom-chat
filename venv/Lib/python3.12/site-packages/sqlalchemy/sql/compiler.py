    ...
    def visit_label_reference(
        ...
        ***REMOVED*** from ke
            ...
            (
                ...
                only_froms,
                only_cols,
    ***REMOVED*** = compile_state._label_resolve_dict
    ...
    def visit_function(
        ...
        ***REMOVED***
            ...
            ***REMOVED***
                ...
                + [name]
    ***REMOVED*** % {"expr": self.function_argspec(func, **kwargs)}
...
***REMOVED***
    ...
    def _literal_execute_expanding_parameter_literal_binds(
        ...
        ***REMOVED*** + self.visit_empty_set_op_expr(
    ...
    ***REMOVED***
            ...
            if bind_expression_template:
                ...
                assert m and m.group(
                    2
        ***REMOVED***, "unexpected format for expanding parameter"
                ...
                if cte.recursive or cte.element.name_cte_columns:
                    ...
                    recur_cols = [
                        ...
                        for (
                            ...
                            c,
                            repeated,
                ***REMOVED*** in (col_source._generate_columns_plus_names(True))
                        if not repeated
                    ]
...
***REMOVED***
    ...
    ***REMOVED***, "proxy_name is required if 'name' is passed"
    ...
    ***REMOVED***
        ...
        ***REMOVED***
                for (
                    ...
                    column,
                    repeated,
        ***REMOVED*** in compile_state.columns_plus_names
            ]
            if c is not None
        ]
                ...
                ***REMOVED*** in compile_state.columns_plus_names
                    ...
                    [
                        ...
                        for (
                            ...
                            name,
                            repeated,
                ***REMOVED*** in compile_state_wraps_for.columns_plus_names
                    ],
        ***REMOVED***
    ***REMOVED***
...
***REMOVED***
    ...
    ***REMOVED***
            for (
                ...
                column,
                repeated,
    ***REMOVED*** in stmt._generate_columns_plus_names(
...
***REMOVED***:
    ...
    ***REMOVED*** and insert_stmt._sort_by_parameter_order:
                raise exc.CompileError(
...
***REMOVED***
    ...
    ***REMOVED***
        ...
        if (
            self.implicit_returning or update_stmt._returning
***REMOVED*** and not self.returning_precedes_values:
            text += " " + self.returning_clause(
                update_stmt,
                self.implicit_returning or update_stmt._returning,
                populate_result_map=toplevel,
...
***REMOVED*** and self.returning_precedes_values:
            text += " " + self.returning_clause(
                delete_stmt,
                self.implicit_returning or delete_stmt._returning,
                populate_result_map=toplevel,
