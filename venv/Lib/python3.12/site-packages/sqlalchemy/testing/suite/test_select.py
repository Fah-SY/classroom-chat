...
***REMOVED***.data([(1, "name1"), (2, "name2"), (3, "name3")])
...
***REMOVED***.bindparams(bindparam("q", type_=String, expanding=True))
        self._assert_result(
            stmt,
            [(2,), (3,), (4,)],
            params={"q": ["z2", "z3", "z4"]},
***REMOVED***
    ...
    def test_untyped_str_in(self):
        ...
        stmt = text(
            "select id FROM some_table WHERE z IN :q ORDER BY id"
***REMOVED***.bindparams(bindparam("q", expanding=True))
        self._assert_result(
            stmt,
            [(2,), (3,), (4,)],
            params={"q": ["z2", "z3", "z4"]},
...
***REMOVED***
    ...
    def test_window(self, connection):
        ...
        ***REMOVED***
    ***REMOVED***.where(some_table.c.col1 < 20)
***REMOVED***.all()
