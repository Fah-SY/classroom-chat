...
class OmgIdlLexer(CLexer):
    ...
    tokens = {
        ...
        'root': [
            ...
            (words((
                'typedef', 'const',
                'in', 'out', 'inout', 'local',
    ***REMOVED***, prefix=r'(?i)', suffix=r'\b'), Keyword.Declaration),
            (words((
    ...
    ***REMOVED***, prefix=r'(?i)', suffix=r'\b'), Keyword.Type),
            (words((
                '@annotation', 'struct', 'union', 'bitset', 'interface',
                'exception', 'valuetype', 'eventtype', 'component',
    ***REMOVED***, prefix=r'(?i)', suffix=r'(\s+)(\w+)'), bygroups(Keyword, Whitespace, Name.Class)),
            (words((
    ...
    ***REMOVED***, prefix=r'(?i)', suffix=r'\b'), Keyword),
