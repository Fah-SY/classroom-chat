...
class HasHints:
    ...
    ***REMOVED***.with_hint(mytable, "WITH INDEX ix_mytable", "mssql")
...
***REMOVED*** -> Union[FromGrouping, Self]: ...
...
***REMOVED***.self_group()
    ...
    ***REMOVED***.self_group(against=operators._asbool)
...
***REMOVED***
        ...
        def replace(
            ...
            **kw: Any,
***REMOVED*** -> Optional[KeyedColumnElement[Any]]:
...
***REMOVED***.alias(name=name, flat=flat)
...
***REMOVED***
    ...
    def union(self, *other: _SelectStatementForCompoundArgument[Any]) -> CTE:
        ...
        assert is_select_statement(
            self.element
***REMOVED***, f"CTE element f{self.element} does not support union()"
...
***REMOVED***
    ...
    def union_all(
        ...
        assert is_select_statement(
            self.element
***REMOVED***, f"CTE element f{self.element} does not support union_all()"
...
class HasCTE(roles.HasCTERole, SelectsRows):
    ...
    ***REMOVED***.add_cte(delete_statement_cte)
    ...
    ***REMOVED***
        ...
        ***REMOVED***.where(parts_alias.c.part == incl_alias.c.sub_part)
    ***REMOVED***

            statement = select(
                included_parts.c.sub_part,
                func.sum(included_parts.c.quantity).label("total_quantity"),
    ***REMOVED***.group_by(included_parts.c.sub_part)
...
***REMOVED***,
    ...
    if TYPE_CHECKING:
        ...
        def columns(
            self,
***REMOVED*** -> ReadOnlyColumnCollection[str, ColumnClause[Any]]: ...
...
class CompoundSelect(HasCompileState, GenerativeSelect, TypedReturnsRows[_TP]):
    ...
    ***REMOVED***.self_group(against=self)
            for s in selects
        ]
...
***REMOVED***:
    ...
    def _setup_joins(
        ...
        ***REMOVED*** = self._join_determine_implicit_left_side(
    ...
    def _filter_by_zero(
        ...
        if self._setup_joins:
            meth = SelectState.get_plugin_class(
                self
    ***REMOVED***.determine_last_joined_entity
...
***REMOVED*** -> ScalarSelect[Any]: ...

        @overload
        def scalar_subquery(
            self: Select[Tuple[_NOT_ENTITY]],
***REMOVED*** -> ScalarSelect[_NOT_ENTITY]: ...
    ...
    def _generate_fromclause_column_proxies(
        ...
        ***REMOVED***
                for (
                    ...
                    c,
                    repeated,
        ***REMOVED*** in (self._generate_columns_plus_names(False))
                if is_column_element(c)
            ]
