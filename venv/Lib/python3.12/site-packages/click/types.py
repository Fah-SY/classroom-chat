    ...
    ***REMOVED***
    ...
    def get_invalid_choice_message(self, value: t.Any, ctx: Context | None) -> str:
        ...
        return ngettext(
            ...
            len(self.choices),
***REMOVED***.format(value=value, choice=choices_str, choices=choices_str)
    ...
    def convert(
        ...
        self.fail(
            ngettext(
                ...
                len(self.formats),
    ***REMOVED***.format(value=value, format=formats_str, formats=formats_str),
            param,
            ctx,
***REMOVED***
        ...
        if len_value != len_type:
            self.fail(
                ngettext(
                    ...
                    len_value,
        ***REMOVED***.format(len_type=len_type, len_value=len_value),
                param=param,
                ctx=ctx,
    ***REMOVED***
