...
***REMOVED***:
    ...
    ***REMOVED*** and mapper.version_id_generator is not False:
...
***REMOVED***:
    ...
    ***REMOVED***
        ...
        ***REMOVED*** in zip(records, result.context.compiled_parameters):
                    if state:
                        _postfetch(
                            mapper_rec,
                            uowtransaction,
