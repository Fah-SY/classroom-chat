        ...
        ***REMOVED***
            ...
            ***REMOVED***:
            ...
            for mapper in self.iterate_to_root():
                ...
                ***REMOVED***.corresponding_column(mapper.polymorphic_on)
    ...
    def _should_exclude(self, name, assigned_name, local, column):
        ...
        if local:
            if self.class_.__dict__.get(
                assigned_name, None
    ***REMOVED*** is not None and self._is_userland_descriptor(
