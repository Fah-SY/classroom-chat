    ...
    tokens = {
        'expression': [
            ...
            (words((
                    ...
                    'do'
        ***REMOVED***, prefix=r'\b', suffix=r'\b'), Keyword),
    ...
    ***REMOVED***), Operator),
        ...
        'root': [
            (words((
                ...
                'open',
                'attribute',
    ***REMOVED***, prefix=r'\b', suffix=r'\b'), Keyword.Namespace),
            (words((
                ...
                'set_option',
                'run_cmd',
    ***REMOVED***, prefix=r'\b', suffix=r'\b'), Keyword.Declaration),
            (r'@\[', Keyword.Declaration, 'attribute'),
            (words((
                '#eval', '#check', '#reduce', '#exit',
                '#print', '#help',
    ***REMOVED***, suffix=r'\b'), Keyword),
            include('expression')
        ],
        'attribute': [
