...
class next_value(GenericFunction[int]):
    ...
    def __init__(self, seq: schema.Sequence, **kw: Any) -> None:
        assert isinstance(
            seq, schema.Sequence
***REMOVED***, "next_value() accepts a Sequence object as input."
        self.sequence = seq
...
***REMOVED***.group_by(func.cube(table.c.col_1, table.c.col_2))
...
class rollup(GenericFunction[_T]):
    ...
    e.g. :meth:`_expression.Select.group_by`::
        ...
        stmt = select(
            func.sum(table.c.value), table.c.col_1, table.c.col_2
***REMOVED***.group_by(func.rollup(table.c.col_1, table.c.col_2))
...
class grouping_sets(GenericFunction[_T]):
    ...
    e.g. :meth:`_expression.Select.group_by`::
        ...
        stmt = select(
            func.sum(table.c.value), table.c.col_1, table.c.col_2
***REMOVED***.group_by(func.grouping_sets(table.c.col_1, table.c.col_2))
