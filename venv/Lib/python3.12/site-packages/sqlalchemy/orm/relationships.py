...
***REMOVED*** -> RelationshipProperty.Comparator[Any]:
    ...
    ***REMOVED***
        ...
        def __clause_element__(self) -> ColumnElement[bool]:
            ...
            (
                ...
                secondary,
                target_adapter,
    ***REMOVED*** = self.prop._create_joins(
    ...
    ***REMOVED***
        ...
        ***REMOVED***
            ...
            (
                ...
                secondary,
                target_adapter,
    ***REMOVED*** = self.property._create_joins(
    ...
    def _columns_are_mapped(self, *cols: ColumnElement[Any]) -> bool:
        ...
        for c in cols:
            ...
            if not self.parent.persist_selectable.c.contains_column(
                c
    ***REMOVED*** and not self.target.c.contains_column(c):
                return False
        return True
...
***REMOVED***
        ...
        (
            ...
            target_adapter,
            dest_selectable,
***REMOVED*** = self._join_condition.join_targets(
            source_selectable,
            dest_selectable,
            aliased,
            single_crit,
...
***REMOVED*** -> Optional[ColumnElement[Any]]:
    ...
    ***REMOVED*** or not isinstance(binary.right, sql.ColumnElement):
                return
...
***REMOVED*** -> Tuple[ColumnElement[Any], ColumnElement[Any]]:
    ...
    ***REMOVED***:
                if self.child_persist_selectable.c.contains_column(
                    right
        ***REMOVED*** and self.parent_persist_selectable.c.contains_column(left):
...
***REMOVED***
    ...
    ***REMOVED***.difference(self.child_persist_selectable.c)
...
***REMOVED***
    ...
    ***REMOVED***
        ...
        ***REMOVED***.chain(primary_aliasizer)
...
***REMOVED*** -> Optional[BindParameter[Any]]:
            if (
