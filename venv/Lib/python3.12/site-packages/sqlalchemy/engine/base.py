...
***REMOVED***
        ...
        if self._has_events or self.engine._has_events:
            (
                ...
                event_multiparams,
                event_params,
    ***REMOVED*** = self._invoke_before_exec_event(
        ...
        if not self._is_disconnect:
            self._is_disconnect = (
                ...
                and self.dialect.is_disconnect(
                    ...
                    cursor,
        ***REMOVED***
    ***REMOVED*** or (is_exit_exception and not self.closed)
...
***REMOVED***
        if self._reentrant_error:
            raise exc.DBAPIError.instance(
                ...
                dialect=self.dialect,
                ismulti=ismulti,
    ***REMOVED***.with_traceback(exc_info[2]) from e
    ...
    ***REMOVED*** and dialect.is_disconnect(e, None, None)
...
***REMOVED***.traverse_single(element)
