    ...
    ***REMOVED***
    ...
    def _repr_param_dict(self, params: _CoreSingleExecuteParams) -> str:
        ...
        (
            ...
            items_second_batch,
            trunclen,
***REMOVED*** = self._get_batches(params.items())
    ...
    ***REMOVED***
    ...
    def _repr_param_tuple(self, params: Sequence[Any]) -> str:
        ...
        (
            ...
            items_second_batch,
            trunclen,
***REMOVED*** = self._get_batches(params)
...
***REMOVED*** -> Optional[ExternallyTraversible]: ...
...
***REMOVED***
    ...
    ***REMOVED*** or (self.parent.exclude_fn and self.parent.exclude_fn(key)):
