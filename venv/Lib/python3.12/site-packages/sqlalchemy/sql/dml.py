...
***REMOVED***.as_readonly()
    ...
    def returning_column_descriptions(self) -> List[Dict[str, Any]]:
        ...
        meth = DMLState.get_plugin_class(
            self
***REMOVED***.get_returning_column_descriptions
        return meth(self)
        ...
        ***REMOVED***
                ...
                if arg and isinstance(arg[0], dict):
                    multi_kv_generator = DMLState.get_plugin_class(
                        self
            ***REMOVED***._get_multi_crud_kv_pairs
...
***REMOVED*** -> ReturningInsert[Tuple[_T0]]: ...
        ...
        def returning(
            ...
            *,
            sort_by_parameter_order: bool = False,
***REMOVED*** -> ReturningInsert[Tuple[_T0, _T1]]: ...
        ...
        def returning(
            ...
            *,
            sort_by_parameter_order: bool = False,
***REMOVED*** -> ReturningInsert[Tuple[_T0, _T1, _T2]]: ...
        ...
        def returning(
            ...
            *,
            sort_by_parameter_order: bool = False,
***REMOVED*** -> ReturningInsert[Tuple[_T0, _T1, _T2, _T3]]: ...
        ...
        def returning(
            ...
            *,
            sort_by_parameter_order: bool = False,
***REMOVED*** -> ReturningInsert[Tuple[_T0, _T1, _T2, _T3, _T4]]: ...
        ...
        def returning(
            ...
            *,
            sort_by_parameter_order: bool = False,
***REMOVED*** -> ReturningInsert[Tuple[_T0, _T1, _T2, _T3, _T4, _T5]]: ...
        ...
        def returning(
            ...
            *,
            sort_by_parameter_order: bool = False,
***REMOVED*** -> ReturningInsert[Tuple[_T0, _T1, _T2, _T3, _T4, _T5, _T6]]: ...
...
***REMOVED*** -> ReturningUpdate[Tuple[_T0]]: ...

        @overload
        def returning(
            self, __ent0: _TCCA[_T0], __ent1: _TCCA[_T1]
***REMOVED*** -> ReturningUpdate[Tuple[_T0, _T1]]: ...

        @overload
        def returning(
            self, __ent0: _TCCA[_T0], __ent1: _TCCA[_T1], __ent2: _TCCA[_T2]
***REMOVED*** -> ReturningUpdate[Tuple[_T0, _T1, _T2]]: ...
        ...
        def returning(
            ...
            __ent2: _TCCA[_T2],
            __ent3: _TCCA[_T3],
***REMOVED*** -> ReturningUpdate[Tuple[_T0, _T1, _T2, _T3]]: ...
        ...
        def returning(
            ...
            __ent3: _TCCA[_T3],
            __ent4: _TCCA[_T4],
***REMOVED*** -> ReturningUpdate[Tuple[_T0, _T1, _T2, _T3, _T4]]: ...
        ...
        def returning(
            ...
            __ent4: _TCCA[_T4],
            __ent5: _TCCA[_T5],
***REMOVED*** -> ReturningUpdate[Tuple[_T0, _T1, _T2, _T3, _T4, _T5]]: ...
        ...
        def returning(
            ...
            __ent5: _TCCA[_T5],
            __ent6: _TCCA[_T6],
***REMOVED*** -> ReturningUpdate[Tuple[_T0, _T1, _T2, _T3, _T4, _T5, _T6]]: ...
...
***REMOVED***
    ...
    if TYPE_CHECKING:
        ...
        def returning(
            self, __ent0: _TCCA[_T0]
***REMOVED*** -> ReturningDelete[Tuple[_T0]]: ...

        @overload
        def returning(
            self, __ent0: _TCCA[_T0], __ent1: _TCCA[_T1]
***REMOVED*** -> ReturningDelete[Tuple[_T0, _T1]]: ...

        @overload
        def returning(
            self, __ent0: _TCCA[_T0], __ent1: _TCCA[_T1], __ent2: _TCCA[_T2]
***REMOVED*** -> ReturningDelete[Tuple[_T0, _T1, _T2]]: ...
        ...
        def returning(
            ...
            __ent2: _TCCA[_T2],
            __ent3: _TCCA[_T3],
***REMOVED*** -> ReturningDelete[Tuple[_T0, _T1, _T2, _T3]]: ...
        ...
        def returning(
            ...
            __ent3: _TCCA[_T3],
            __ent4: _TCCA[_T4],
***REMOVED*** -> ReturningDelete[Tuple[_T0, _T1, _T2, _T3, _T4]]: ...
        ...
        def returning(
            ...
            __ent4: _TCCA[_T4],
            __ent5: _TCCA[_T5],
***REMOVED*** -> ReturningDelete[Tuple[_T0, _T1, _T2, _T3, _T4, _T5]]: ...
        ...
        def returning(
            ...
            __ent5: _TCCA[_T5],
            __ent6: _TCCA[_T6],
***REMOVED*** -> ReturningDelete[Tuple[_T0, _T1, _T2, _T3, _T4, _T5, _T6]]: ...
