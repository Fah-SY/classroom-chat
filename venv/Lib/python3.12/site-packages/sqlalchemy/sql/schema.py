...
***REMOVED***
    ...
    if TYPE_CHECKING:
        ...
        def exported_columns(
            self,
***REMOVED*** -> ReadOnlyColumnCollection[str, Column[Any]]: ...
...
***REMOVED***._set_parent_with_dispatch(self)
...
***REMOVED***:
    ...
    ***REMOVED*** in dialect_options.items():
        ...
        *columns: _DDLColumnArgument,
        ...
        if processed_expressions is not None:
            ...
            for (
                ...
                _,
                add_element,
    ***REMOVED*** in coercions.expect_col_expression_collection(
    ...
    ***REMOVED***:
        ...
        if len(self._columns) == 1:
            ...
            if col.autoincrement is True:
                ...
                "auto",
                "ignore_fk",
    ***REMOVED*** and _validate_autoinc(col, False):
                return col
            else:
                return None
...
***REMOVED*** or not isinstance(parent.server_onupdate, (type(None), Computed)):
            raise exc.ArgumentError(
...
***REMOVED*** or not isinstance(parent.server_onupdate, type(None)):
            raise exc.ArgumentError(
