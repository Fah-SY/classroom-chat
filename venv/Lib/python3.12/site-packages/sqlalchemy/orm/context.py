...
class AutoflushOnlyORMCompileState(AbstractORMCompileState):
    ...
    def orm_pre_session_exec(
        ...
        (
            load_options,
            execution_options,
***REMOVED*** = QueryContext.default_load_options.from_execution_options(
...
***REMOVED***.get_column_descriptions
        return meth(self)
...
***REMOVED***:
            for (
                memoized_entities
    ***REMOVED*** in select_statement._memoized_select_entities:
...
***REMOVED***
    ...
    ***REMOVED***
            ...
            (
                replace_from_obj_index,
                use_entity_index,
    ***REMOVED*** = self._join_place_explicit_left_side(entities_collection, left)
...
***REMOVED***:
        ...
        ***REMOVED*** and sql_util.selectables_overlap(
...
***REMOVED***
    ...
    def _get_extra_criteria(self, ext_info):
        if (
            ...
            ext_info.mapper,
***REMOVED*** in self.global_attributes:
            return tuple(
    ...
    def corresponds_to(self, entity):
        if _is_aliased_class(entity):
            ...
            return not _is_aliased_class(
                self.entity_zero
    ***REMOVED*** and entity.common_parent(self.entity_zero)
