    ...
    class Comparator(TypeEngine.Comparator[_T]):
        ...
        def __getitem__(self, index):
            (
                ...
                adjusted_right_expr,
                result_type,
    ***REMOVED*** = self._setup_getitem(index)
            return self.operate(
...
***REMOVED***
    ...
    class JSONElementType(TypeEngine[Any]):
        ...
        def string_bind_processor(
            self, dialect: Dialect
***REMOVED*** -> Optional[_BindProcessorType[str]]:
            return self._string._cached_bind_processor(dialect)

        def string_literal_processor(
            self, dialect: Dialect
***REMOVED*** -> Optional[_LiteralProcessorType[str]]:
        ...
        def literal_processor(
            self, dialect: Dialect
***REMOVED*** -> _LiteralProcessorType[Any]:
    ...
    ***REMOVED*** or self.expr.operator not in (
...
***REMOVED***
    ...
    ***REMOVED***
    ...
    class Comparator(
        ...
        def _setup_getitem(
            self, index: int
***REMOVED*** -> Tuple[OperatorType, int, TypeEngine[Any]]: ...

        @overload
        def _setup_getitem(
            self, index: slice
***REMOVED*** -> Tuple[OperatorType, Slice, TypeEngine[Any]]: ...
...
***REMOVED*** -> Tuple[OperatorType, TypeEngine[Any]]:
    ...
    ***REMOVED*** or not operators.is_commutative(op):
