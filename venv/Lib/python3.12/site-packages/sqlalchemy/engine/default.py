...
***REMOVED***:
            ...
            ***REMOVED***
                ...
                ***REMOVED***
                    ...
                    ***REMOVED***.type._cached_result_processor(
...
***REMOVED***._inserted_primary_key_from_lastrowid_getter
...
***REMOVED***._inserted_primary_key_from_lastrowid_getter
    ...
    def _setup_ins_pk_from_implicit_returning(self, result, rows):
        ...
        getter = cast(
            SQLCompiler, self.compiled
***REMOVED***._inserted_primary_key_from_returning_getter
