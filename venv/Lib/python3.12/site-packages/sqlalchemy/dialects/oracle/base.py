    ...
    ***REMOVED***
    ...
    def _get_nonansi_join_whereclause(self, froms):
        ...
        def visit_join(join):
            ...
            ***REMOVED*** and join.right.is_derived_from(binary.left.table):
                        binary.left = _OuterJoinColumn(binary.left)
                    elif isinstance(
                        binary.right, expression.ColumnClause
            ***REMOVED*** and join.right.is_derived_from(binary.right.table):
...
***REMOVED***.where(dictionary.all_synonyms.c.owner == owner)
        if has_filter_names:
            query = query.where(
...
***REMOVED***.scalars()
    ...
    ***REMOVED***
        ...
        ***REMOVED***.not_in(self.exclude_tablespaces)
    ***REMOVED***
        query = query.where(
...
***REMOVED***.where(dictionary.all_mviews.c.owner == den_schema)
...
***REMOVED***
    ...
    ***REMOVED***,
            dictionary.all_tables.c.tablespace_name,
***REMOVED***.where(dictionary.all_tables.c.owner == owner)
        if has_filter_names:
            query = query.where(
...
***REMOVED***
    ...
    ***REMOVED***
    ...
    def _column_query(self, owner):
        ...
        ***REMOVED***.label("identity_options"),
    ***REMOVED***
...
***REMOVED***.order_by(all_cols.c.table_name, all_cols.c.column_id)
        return query
        ...
        ***REMOVED***
        ...
        if resolve_synonyms and all_remote_owners:
            query = select(
                ...
                dictionary.all_synonyms.c.table_owner,
                dictionary.all_synonyms.c.synonym_name,
    ***REMOVED***.where(dictionary.all_synonyms.c.owner.in_(all_remote_owners))
