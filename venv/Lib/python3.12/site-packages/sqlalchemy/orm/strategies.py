    ...
    ***REMOVED***
    ...
    for m in mapper.self_and_descendants:
        if prop is m._props.get(
            prop.key
***REMOVED*** and not m.class_manager._attr_has_impl(prop.key):
...
***REMOVED*** = join_condition.create_lazy_clause()

        (
            self._rev_lazywhere,
            self._rev_bind_to_col,
            self._rev_equated_columns,
***REMOVED*** = join_condition.create_lazy_clause(reverse_direction=True)
...
***REMOVED***
    ...
    ***REMOVED***
        ...
        ***REMOVED***:
            ...
            ***REMOVED***.lazyload(rev).process_compile_state(compile_context)
...
class ImmediateLoader(PostLoader):
    ...
    def init_class_attribute(self, mapper):
        self.parent_property._get_strategy(
            (("lazy", "select"),)
***REMOVED***.init_class_attribute(mapper)
    ...
    def create_row_processor(
        ...
        (
            ...
            execution_options,
            recursion_depth,
***REMOVED*** = self._setup_for_recursion(context, path, loadopt, self.join_depth)
...
***REMOVED***
        ...
        if user_defined_adapter is not False:
            ...
            (
                ...
                adapter,
                add_to_collection,
    ***REMOVED*** = self._setup_query_on_user_defined_adapter(
                compile_state,
                query_entity,
                path,
                adapter,
    ...
    ***REMOVED*** = self._generate_row_adapter(
                compile_state,
                query_entity,
                path,
                loadopt,
...
***REMOVED***
        if with_poly_entity is not None:
            with_polymorphic = inspect(
                with_poly_entity
    ***REMOVED***.with_polymorphic_mappers
        else:
        ...
        ***REMOVED***
            ...
            ***REMOVED***
            ...
            if entity_inside_join_structure is False:
                assert (
                    False
        ***REMOVED***, "assertion failed attempting to produce joined eager loads"
            return None
...
***REMOVED***.init_class_attribute(mapper)
    ...
    ***REMOVED***
        ...
        (
            ...
            execution_options,
            recursion_depth,
***REMOVED*** = self._setup_for_recursion(
